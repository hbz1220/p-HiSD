# Section 7.5.1: read the five history CSV files produced by run.m.
# Plot the saved discrete L2 residuals as Figure 6 in outputs/7.5/7.5.1/5.1.pdf.
...
def plot_all(data_dir: Path) -> Path:
    ...
    for filename, label in SERIES:
        ...
        # Restrict the plotted interval without changing the saved convergence histories.
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Directory for input CSV files and the output figure.",
    )
